...
void statistique::on_statistique_accepted()
{
   ...
   st->show();*/
    ...
    ticks << 1 << 2 << 3 << 4 << 5 ;
    QSqlQuery q;
q.prepare("select jobb ,count(ID)as somme from EMPLOYER group by jobb ");
...
void statistique::on_pushButton_clicked()
{
   ...
   st->show();*/
    ...
    regen->setName("STATISTIQUE jobb");
    regen->setPen(QPen(QColor(0, 168, 140).lighter(180)));
    regen->setBrush(QColor(0, 168, 140));
...
void statistique::on_pushButton_2_clicked()
{
   ...
   st->show();*/
    ...
    ticks << 1 << 2 << 3 << 4 << 5 ;
    QSqlQuery q;
q.prepare("select ADRESSE ,count(ID)as somme from EMPLOYER group by ADRESSE ");
